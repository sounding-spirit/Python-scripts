...
for file in dirlist:
    with io.open(file, 'rb') as image_file:
        ...
        image = vision.Image(content=content) # type changed to vision because of updates on Google api
        ...
        json_out = os.path.join(json_dir, os.path.basename(file).rstrip('.jpg')+'.json')
